...
# === Умный локальный поиск (с расширенными синонимами) ===
def search_in_knowledge_base(query: str) -> Optional[str]:
    ...
    # Мега-карта разделов (расширенные ключевые слова)
    sections_map: List[Tuple[List[str], str]] = [
        # РЕЖИМ РАБОТЫ — добавлены все возможные формулировки
        (["режим", "часы", "работает", "открыта", "закрыта", "график", "во сколько", "время",
          ...
          "часы работы", "график работы", "режим работы", "рабочие часы", "время работы",
          "подскажи режим", "подскажи время", "подскажите время работы", "как работает",
          "рабочий день", "библиотека работает", "открытие", "закрытие", "когда можно прийти"],
         "=== РЕЖИМ РАБОТЫ ==="),
        # КОНТАКТЫ
        (["телефон", "контакты", "позвонить", "связаться", "номер", "почта", "email", "mail",
          ...
          "как связаться", "куда звонить", "есть телефон", "номер телефона"],
         "=== КОНТАКТЫ ==="),
        # РУКОВОДСТВО
        (["директор", "руководство", "абрамова", "заместитель", "зам", "левин", "начальник",
          ...
          "кто директор", "фамилия директора", "заместитель директора"],
        ...
        (["кампусная", "карта", "читательский", "билет", "пропуск", "удостоверение", "студенческий",
          ...
          "получить карту", "оформить билет", "кампусная карта где получить"],
         "=== КАМПУСНАЯ КАРТА ==="),
        # МФЦ
        ...
        (["получить", "выдача", "взять", "заказать", "заказ", "бронь", "учебники", "литературу",
          ...
          "взять книги", "получить литературу"],
        ...
        (["личный кабинет", "логин", "пароль", "авторизация", "вход", "аккаунт", "профиль",
          ...
          "пароль от личного кабинета", "логин для входа"],
         "=== ЛИЧНЫЙ КАБИНЕТ ==="),
        # АДРЕС
        ...
        (["электронные", "ресурсы", "базы", "знаниум", "ивис", "подписка", "доступ", "удаленка",
          ...
          "как зайти в электронную библиотеку", "доступ к базам"],
         "=== ДОСТУПНЫЕ ЭЛЕКТРОННЫЕ РЕСУРСЫ ==="),
        # ОБРАТНАЯ СВЯЗЬ
        (["обратная связь", "отзыв", "предложение", "жалоба", "пожаловаться", "вопрос", "поддержка",
          "помощь", "написать отзыв", "оставить жалобу", "форма обратной связи"],
         "=== ОБРАТНАЯ СВЯЗЬ ==="),
        # ЗАПИСЬ В БИБЛИОТЕКУ
